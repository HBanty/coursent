...
function Dashboard() {
  ...
  useEffect(() => {
    ...
    if (name) {
      ...
      setFirstName(parsed.admin.firstName); // not parsed.firstName directly
    }
  }, []);
    ...
    <div className="flex h-screen">
      ...
      <div className="w-64 bg-gray-100 p-5">
        <div className="flex items-center flex-col mb-10">
          ...
          <h2 className="text-lg font-semibold mt-1">{firstName}</h2>
          <h2 className="text-lg font-semibold mt-2">Welcome to Admin</h2>
        </div>
