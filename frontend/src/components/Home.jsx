      ...
      <div className="h-[1250px] md:h-[1050px] text-white container mx-auto w-full px-0">
        ...
        <section className="text-center py-20">
          ...
          <div className="space-x-4 mt-8">
            <Link
              to={"/courses"}
              className="bg-green-600 text-white py-3 px-6  rounded font-semibold hover:bg-white duration-300 hover:text-black"
            >
              Explore courses
            </Link>
            <Link
              to={"http://www.youtube.com/@yourtimepass1031"}
              className="bg-white text-black py-3 px-6 rounded font-semibold hover:bg-green-600 duration-300 hover:text-white"
            >
              courses vedio
            </Link>
          </div>
                  ...
                  <div className="bg-gray-900 rounded-lg overflow-hidden">
                    ...
                    <div className="p-6 text-center">
                      ...
                      <Link to={`/course/${course._id}`}>
                        <button className="mt-8 bg-orange-500 ...">
                          Enroll Now
                        </button>
            ...
            <div className="flex flex-col items-center md:items-start">
              ...
              <div className="mt-3 ml-2 md:ml-8">
                ...
                <div className="flex space-x-4 mb-2">
                  ...
                  <a href="">
                    <FaXTwitter className="hover:text-blue-600 duration-300" />
                  </a>
                </div>
              </div>
            </div>
